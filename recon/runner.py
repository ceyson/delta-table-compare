    ...
    df = get_spark().createDataFrame(
        ...
        schema=T.StructType(
            [
                ...
                T.StructField("critical_column_count", T.LongType(), False),
                T.StructField("noncritical_column_count", T.LongType(), False),
                T.StructField("total_compare_column_count", T.LongType(), False),
                T.StructField("hash_group_size", T.LongType(), False),
